...
jurisdictions/za/product-legal/router.md and load the topic overlays and statute files listed for
the active skill.

**Shared company profile.** Company-level facts (who you are, what you do, where you operate, your risk posture, key people) live in `~/.claude/plugins/config/claude-for-legal/company-profile.md` — one level above this file, shared by all 12 plugins. Read it before this plugin's practice profile. If it doesn't exist, this plugin's setup will create it.
-->

# Product Legal Practice Profile — South Africa
*Written by cold-start on [DATE]. If `[PLACEHOLDER]`, run `/product-legal:cold-start-interview`.*
...
**B-BBEE level:** [PLACEHOLDER — Level 1-8 / non-compliant / exempted micro-enterprise / qualifying small enterprise / unknown]
...
Skills in this plugin produce legal analysis (launch review memos,
...
- **In-house counsel** — privilege for in-house legal advisers depends on the capacity in which they act. Communications made in a **legal capacity** (providing legal advice) attract privilege; communications made in a **commercial or managerial capacity** (business strategy, product management, operational decisions) generally do not. The distinction is fact-specific. A launch review memo from in-house counsel that blends legal advice with business recommendations risks losing privilege over the entire document. Where possible, separate legal advice into a standalone memorandum marked as privileged.
- **Product-legal-specific caution:** A launch review memo prepared in a legal capacity may attract privilege; the same memo reframed as a "product risk assessment" for a cross-functional audience (product managers, engineers, marketing) likely does not. The label matters less than the dominant purpose. If the dominant purpose is legal advice to the client, privilege may attach. If the dominant purpose is business risk management for a cross-functional team, it generally will not — regardless of who wrote it.
- **Litigation privilege** protects documents prepared for the dominant purpose of pending or contemplated litigation. Advisory memoranda, launch reviews, and compliance assessments prepared in the ordinary course of business are not protected by litigation privilege.
- **No general protection for internal analyses.** Compliance assessments, regulatory risk reports, CPA gap analyses, POPIA impact assessments, and product launch reviews are generally not privileged unless prepared at the specific direction of a legal practitioner for the purpose of giving legal advice or in contemplation of litigation.

When the header says `PRIVILEGED & CONFIDENTIAL`, it is an assertion that the document was prepared in a legal capacity for the purpose of providing legal advice. If that is not accurate — if the document is a product risk assessment, a compliance review, or a cross-functional launch memo that happens to be written by a lawyer — the header does not create a privilege that doesn't exist. A false privilege claim is worse than no marking: it creates a false sense of security and may be challenged successfully in regulatory proceedings or litigation.

*Remove the header from externally-facing deliverables (customer-facing T&Cs, marketing materials, regulatory submissions, public FAQs) — see the specific skill's instructions. Privilege depends on facts beyond labeling; the internal-investigation skill has additional privilege-formation requirements.*

**Non-lawyer output mode.** When the practice profile says the user is not a lawyer, structure outputs for a reader who can't unpack legal shorthand: (1) the attorney brief goes at the top, not buried, (2) every legal flag gets a one-line plain-English gloss in parentheses, (3) every statutory cite gets a plain-English subject line. Example: "Flag: potential CPA s61 product liability exposure — the Consumer Protection Act imposes strict liability on producers, importers, distributors, and retailers for harm caused by defective, unsafe, or hazardous goods, regardless of negligence." Test: could the reader take the output to their boss and explain it without a lawyer in the room?
...
> "You mentioned CPA doesn't apply to B2B transactions — my understanding is it applies to B2B where the juristic person's turnover is below R2 million (CPA s5(2)(b)). Can you confirm? `[premise flagged — verify]`"
...
- `[platform policy — verify against live docs]` — platform rules (Apple, Google, ESRB, card networks, app stores) cited without fetching the live policy page. Platform rules change without notice and the model's snapshot is almost always stale.
...
- **`[settled — last confirmed YYYY-MM-DD]`** — stable statutory and regulatory references that have been checked against a primary source on the stated date. The date matters: "stable" references change. The CPA juristic person threshold may be updated by the Minister. The Information Regulator's enforcement posture is evolving rapidly. The date tells the reader when the confidence was earned and whether it's earned it lately. When you can't confirm the date of the last check, use `[model knowledge — verify]` instead — an unconfirmed "settled" is the confident overclaim we built the whole attribution system to prevent. Note: never use `[settled]` for a platform policy — those change without notice.
...
- When the destination looks outside the circle: flag it. "You asked for a version for #product-all — that's a company-wide channel, which would waive the privileged protection on this analysis. I can give you (a) the privileged version for legal only, (b) a sanitized version for the broader channel, or (c) both. Which do you want?"
...
SA regulatory bodies relevant to product-legal. Fill in current status for each applicable regulator.

| Regulator | Jurisdiction | Status |
|---|---|---|
| NCC (National Consumer Commission) | Consumer protection (CPA) | [PLACEHOLDER — no interaction / complaint received / under investigation] |
| Information Regulator | POPIA / PAIA | [PLACEHOLDER — no interaction / complaint received / assessment notice / enforcement notice] |
| Competition Commission | Competition Act | [PLACEHOLDER — no interaction / complaint received / under investigation / merger notification pending] |
| ARB (Advertising Regulatory Board) | Advertising standards | [PLACEHOLDER — member / non-member / complaint received / ruling against] |
| ICASA | Telecommunications / OTT | [PLACEHOLDER — only if telecom/OTT — licensed / licence pending / not applicable] |
| SAHPRA | Health products / health-tech | [PLACEHOLDER — only if health-tech — registered / registration pending / not applicable] |
| NGB / FPB | Gaming / content classification | [PLACEHOLDER — only if gaming/content — compliant / pending / not applicable] |
| FSCA / SARB | Financial services / fintech | [PLACEHOLDER — only if fintech — licensed / exemption applies / not applicable] |
...
**B-BBEE level:** [PLACEHOLDER — Level 1-8 / non-compliant / exempted micro-enterprise / qualifying small enterprise / unknown]
**Procurement implications:** [PLACEHOLDER — e.g., required for public sector tenders, contractual BEE obligations to enterprise clients, supply chain scoring impact]
**Public sector sales:** [PLACEHOLDER — active / planned / not pursuing / not applicable]

---

## CPA compliance posture

**CPA applicability:** [PLACEHOLDER — B2C / B2B below threshold (juristic person turnover below R2 million — CPA s5(2)(b)) / B2B above threshold (CPA does not apply) / mixed]
**Plain language compliance (s22):** [PLACEHOLDER — all consumer-facing documents reviewed / partial review / not reviewed]
**Unfair terms review of T&Cs (s48-52):** [PLACEHOLDER — last reviewed [date] / not reviewed]
**Product liability exposure (s61):** [PLACEHOLDER — goods / services only / both / digital products (characterisation uncertain)]
**Product safety monitoring (s60):** [PLACEHOLDER — monitoring process in place / no process / not applicable (services only)]

---

## Promotional competitions

**Runs competitions:** [PLACEHOLDER — regularly / occasionally / never]
**CPA s36 compliance approach:** [PLACEHOLDER — standard process with legal review / ad-hoc / no process]
**Standard competition T&C template:** [PLACEHOLDER — location / none]
...
When a matter involves non-SA jurisdictions, flag it and offer options: search for the applicable standard, route to a specialist, or continue with the SA framework tagged. Specifically:

1. **Detect.** Check the practice profile's jurisdiction footprint. Check the matter facts (governing law, parties' locations, where the product is sold, where the affected people are). If any of these is non-SA, the SA framework may not fully apply.
2. **Assess.** Does the skill have a framework for this jurisdiction? If yes, use it.
3. **If no framework:** Say so, clearly: "This analysis uses a South African framework ([the statute/regulation]). The matter touches [jurisdiction], where the law is different. Applying SA doctrine alone would give you an incomplete answer."
4. **Offer the next step on the decision tree:**
   ...
   - **Flag the gap and continue with a caveat.** "I'll run the SA framework as the primary structure, but every conclusion is tagged `[SA framework — verify against [jurisdiction] law]`."
...
SA-specific currency items to track: Government Gazette threshold updates (CPA juristic person turnover threshold, NCA rates), ARB Code updates, pending National AI Policy (track 2026/27 developments), Information Regulator enforcement posture changes, CPA amendment proposals, Competition Act amendment proposals, POPIA codes of conduct by sector.
...
**Substantiation standard:** ARB Code of Advertising Practice + CPA s29 (misleading, false, or deceptive representations)
**Comparative claims:** ARB Code (substantiation and fairness requirements); Competition Act s8 for dominant firms (abuse of dominance through exclusionary conduct)
**Promotional competitions:** CPA s36 (rules for promotional competitions, including mandatory disclosures, competition rules, and prize details) + Lotteries Act compliance (ensuring promotional competition does not constitute an unlawful lottery)
...
| Trigger | To | Via |
|---|---|---|
| NCC complaint received | [PLACEHOLDER] | [PLACEHOLDER] |
| Information Regulator query | [PLACEHOLDER] | [PLACEHOLDER] |
| Competition Commission inquiry | [PLACEHOLDER] | [PLACEHOLDER] |
| ARB complaint | [PLACEHOLDER] | [PLACEHOLDER] |
| Consumer Tribunal referral | [PLACEHOLDER] | [PLACEHOLDER] |
