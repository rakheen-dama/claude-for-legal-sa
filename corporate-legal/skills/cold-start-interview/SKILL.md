...
4. **Deal size relative to Competition thresholds:** "What's the typical deal size relative to Competition Act merger thresholds? Below lower threshold (small), intermediate (combined R1bn+ and target R200m+), or large (combined R9.5bn+ and target R280m+)? (Thresholds from 1 May 2026, GN 7029 GG 54020.)"
